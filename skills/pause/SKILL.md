...
4. **Flip status via MCP** so `/hone:resume` can detect the pause and recover the prior status:
...
7. Print: "Checkpoint NN saved. Run `/hone:resume` or `/hone:continue` to pick back up."
