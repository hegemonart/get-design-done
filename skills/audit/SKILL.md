...
2. Verify `.design/STATE.md` exists; abort if not (suggest `/hone:new-project`).
...
6. Recommend next action based on findings (e.g., "Score 2/4 on typography - run `/hone:discuss typography` to gather decisions").
