...
- `.design/DESIGN.md` missing → `"No baseline found. Run /hone:scan first."`
- `.design/DESIGN-VERIFICATION.md` missing → `"No verification result found. Run /hone:verify first to produce DESIGN-VERIFICATION.md."`
