// sdk/mcp/hone-mcp/tools/hone_learnings_digest.ts
//
...
export const name = 'hone_learnings_digest';
export const schemaPath = '../schemas/hone_learnings_digest.schema.json';
