// sdk/mcp/hone-mcp/tools/hone_reflections_latest.ts
//
...
export const name = 'hone_reflections_latest';
export const schemaPath = '../schemas/hone_reflections_latest.schema.json';
