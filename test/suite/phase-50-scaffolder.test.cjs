 ...
 *   6. scripts/skill-templates/new-skill/SKILL.md exists with valid frontmatter.
 *   7. scripts/skill-templates/health/SKILL.md mentions "v3 description form".
 *
...
test('50: scripts/skill-templates/new-skill/SKILL.md exists with valid frontmatter', () => {
