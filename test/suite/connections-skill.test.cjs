 ...
 *   - handles all 27 known connections by name (per connections/connections.md)
...
// The 27 connections the onboarding wizard must handle. Hyphenated names kept as-is
...
test('connections-skill: references all 27 known connections by name', () => {
  const body = fs.readFileSync(SKILL_PATH, 'utf8');
