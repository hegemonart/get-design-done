...
const BASELINE_DIR = path.join(REPO_ROOT, 'test', 'fixtures', 'baselines', 'phase-28.7');
const PHASE_28_6_BASELINE = path.join(REPO_ROOT, 'test', 'fixtures', 'baselines', 'phase-28.6');
const PHASE_28_BASELINE = path.join(REPO_ROOT, 'test', 'fixtures', 'baselines', 'phase-28');
...
describe('Phase 28.7-10: phase-20 skill-list integrity (no skill add/remove)', () => {
  test('28.7-10: phase-20/skill-list.txt unchanged (Phase 28.7 ships install infra, not skills)', () => {
    const skillListPath = path.join(REPO_ROOT, 'test', 'fixtures', 'baselines', 'phase-20', 'skill-list.txt');
