 ...
 *   1. source/skills/instinct/SKILL.md frontmatter is valid (v3 description
 ...
 *   3. source/skills/apply-reflections/SKILL.md documents the [INSTINCT]
 *      proposal class with the accept / reject / defer / edit flow.
 *   4. source/skills/extract-learnings/SKILL.md dual-emits atomic instinct
