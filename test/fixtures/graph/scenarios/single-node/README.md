...
|---|---|
| `build --intel intel.json --out <tmp>/g.json` | exit 0; `{ok:true, nodeCount:1, edgeCount:0}`; written graph has 1 node `id:"component:Button"`, `label:"Button"`, `source:"hone-intel-store"` |
