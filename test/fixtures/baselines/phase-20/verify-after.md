...
- **DESIGN-PLAN.md prerequisite** (normal mode): missing -> block with "Verify requires DESIGN-PLAN.md. Run `/hone:plan` first, or use `--post-handoff` if starting from a Claude Design handoff bundle."
