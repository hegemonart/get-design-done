...
| 44. Editorial Quality Floor — STYLE.md + `scripts/lint-prose.cjs` denylist (em-dashes, AI-tells: "load-bearing", "delves", "elevate", etc.) + frontmatter description denylist + locale handling | 0/5 (2+2+1 across 3 waves) | Planned | v1.44.0 | Depends on Phase 12, 28.5. Soft: 35 |
