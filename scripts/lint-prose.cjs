...
// Default scope: README.md, README.*.md, SKILL.md, source/skills/**/*.md, agents/**/*.md, CHANGELOG.md,
// reference/**/*.md. The GENERATED skills/ + dist/ trees are NOT scanned (source/skills/ is the authored copy).
//
