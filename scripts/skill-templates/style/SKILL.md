...
2. **Mode detect** - `DESIGN-SUMMARY.md` exists → post-pipeline; else `DESIGN.md` exists → pre-pipeline; else abort with a "run {{command_prefix}}scan first" message. Full decision tree at `./style-doc-procedure.md#mode-detection`.
